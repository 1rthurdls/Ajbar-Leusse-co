...
if  len(sys.argv) < 2:
    print("this is a message for the user, in order for you to access the informations you need, you have to follow this structure")
    ...
    if number == '7':
        ...
        if city in listeville:
            ...
            print("ERROR,errortype the number does not corespond to a certain data please enter a number in range 1 to 10")
            sys.exit()
